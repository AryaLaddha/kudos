  ...
  return (
    <div className="relative inline-block w-full sm:w-auto">
      <select
        ...
        className="w-full sm:w-48 appearance-none bg-white border border-slate-200 rounded-xl px-4 py-2 pr-10 text-sm font-bold text-slate-700 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all hover:border-slate-300"
      >
