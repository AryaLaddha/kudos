...
import { Sparkles, LayoutDashboard, User, LogOut, Heart, Coins, Loader2, Trophy, Target, Menu, X, ShieldCheck, Zap, Users, ClipboardCheck, CalendarDays, Layers } from "lucide-react";
...
const navItems = [
  ...
  { href: "/leave", label: "Leave Calendar", icon: CalendarDays },
  { href: "/admin/goals", label: "All Goals", icon: Target, adminLabel: "Goals Management" },
];

const allAdminNavItems = [
  { href: "/admin/goal-approvals", label: "Goal Approvals", icon: ClipboardCheck, permission: "admin" as const },
  { href: "/sprints", label: "Sprints", icon: Zap, permission: "sprints" as const },
  { href: "/admin/streams", label: "Streams", icon: Layers, permission: "admin" as const },
